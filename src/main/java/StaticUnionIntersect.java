...
public class StaticUnionIntersect {
...
//        System.out.println(intersect); //[B, C, C]
        ...
        System.out.println(intersection(list1, list2)); //[B, C]
        System.out.println(intersectFast(list1, list2)); //[B, C]
        System.out.println(union(list1, list2)); //[D, E, F, A, B, C]
    }
    ...
    public static <T> List<T> intersectFast(List<T> list1, List<T> list2) {
